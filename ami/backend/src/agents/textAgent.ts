...
export async function generateImmersiveText(
  ...
  const prompt = [
    ...
    '      "body": "A list of 5-8 descriptive bullet points (pointers) summarizing key concepts. Format each line starting with a bullet point character \'• \' and separate each bullet point with \\n\\n (two newlines). Use **bold** for key terms. Integrate analogies related to: ' + persona.interest + ' within these pointers.",',
    '    },',
    '    {',
    '      "id": "q1",',
    '      "kind": "inline-quiz",',
    ...
    '- Prose bodies (p1, p2, p3, p4): Must be bullet points (pointers) starting with \'• \', separated by \\n\\n. Do NOT write paragraphs.',
